...
# copy file on gcs
gsutil cp -a public-read release/*_win.exe gs://urbanstack_analytics
gsutil cp -a public-read release/*_win.exe gs://urbanstack_analytics/analytics_latest_win.exe